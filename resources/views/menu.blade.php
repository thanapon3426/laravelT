    ...
    <div class="container">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <a class="card-title"  href="/editmenu/{{$post->id}}"><h3>{{$post->title}}</h3></a>
            ...
            <a class="card-title"  href="/edittypet/{{$post->id}}"><h3>Status : {{$post->status}}</h3></a>
        ...
        @endforeach
        <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link"  href= "/createmenu/{{$types}}">
